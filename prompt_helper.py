...
from prompt_creator import rag, rag_llm
...
def ask_LLM(user_query): 
    ...
    answer, token_usage, response_time, search_results = rag_llm(user_query)
    ...
    question_english = parsed_data.get("Question English", "")
    situation_english = parsed_data.get("Situation English", "")
    situation_korean = parsed_data.get("Situation Korean", "")
    answer_english = parsed_data.get("Answer English", "")
    answer_korean = parsed_data.get("Answer Korean", "")
